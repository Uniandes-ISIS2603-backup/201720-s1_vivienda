 ...
 */
@Stateless
public class ApartamentoPersistence {
    private static final Logger LOGGER = Logger.getLogger(ApartamentoPersistence.class.getName());
     ...
     */
     public ApartamentoEntity create(ApartamentoEntity entity){
     ...
     */
    public ApartamentoEntity update(ApartamentoEntity entity) {
        LOGGER.log(Level.INFO, "Actualizando apartamento con id={0}", entity.getNumApartamento());
    ...
    public void delete(Integer id) {
        ...
        ApartamentoEntity entity = em.find(ApartamentoEntity.class, id);
    ...
    public ApartamentoEntity find(Integer id) {
         ...
         */
        return em.find(ApartamentoEntity.class, id);
    }
    ...
    public List<ApartamentoEntity> findAll() {
        ...
        TypedQuery query = em.createQuery("select u from ApartamentoEntity u",ApartamentoEntity.class);
